...
trophy_img = pygame.image.load('../assets/misc/trophy.png')
trophy_img = pygame.transform.scale(trophy_img, (100, 100))
gold_img = pygame.image.load('../assets/misc/gold.png')
gold_img = pygame.transform.scale(gold_img, (40, 50))
silver_img = pygame.image.load('../assets/misc/silver.png')
silver_img = pygame.transform.scale(silver_img, (40, 50))
bronze_img = pygame.image.load('../assets/misc/bronze.png')
